  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-6 ${darkMode ? 'bg-[#0F0B1E] text-white' : 'bg-purple-50 text-black'}`}>
      <div className="bg-white dark:bg-[#18122B] p-8 rounded-xl shadow-lg w-full max-w-md">
        <h2 className="text-3xl font-bold mb-6 text-center text-purple-700 dark:text-purple-300">🔐 Login</h2>
        <form className="flex flex-col gap-4" onSubmit={handleLogin}>
          ...
          <button type="submit" className="bg-purple-600 text-white py-3 rounded-lg hover:bg-purple-700 transition">Login</button>
        </form>
